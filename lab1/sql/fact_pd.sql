...
drop index aircraft_type_name_unique;

drop table aircraft_types_dim;

drop index aircraft_registration_unique;

drop table aircrafts_dim;

drop index airline_code_unique;

drop table airlines_dim;

drop index airport_code_unique;

drop table airports_dim;

drop index airport_type_name_unique;

drop table airports_types_dim;

drop index continent_code_unique;

drop table continents_dim;

drop index country_code_unique;

drop table countries_dim;

drop index time_date_unique;

drop table dates_dim;

drop index designator_unique;

drop table designators_dim;

drop index engine_type_name_unique;

drop table engine_types_dim;

drop table flights_fact;

drop index manufacturer_name_unique;

drop table manufacturers_dim;

drop index model_description_name_unique;

drop table models_descriptions_dim;

drop index region_code_unique;

drop table regions_dim;

drop index route_code_unique;

drop table routes_dim;

drop index turbulence_name;

drop table turbulence_categories_dim;
